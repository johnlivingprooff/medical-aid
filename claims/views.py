...
class PatientViewSet(viewsets.ModelViewSet):
	...
	def coverage_balance(self, request, pk=None):
		...
		benefits = SchemeBenefit.objects.filter(scheme=patient.scheme)
		...
		for b in benefits:
			...
			start = _period_start(b.coverage_period, djtz.now())
...
class ClaimViewSet(viewsets.ModelViewSet):
	...
	search_fields = ['service_type', 'patient__user__username', 'provider__username']
	...
	def perform_create(self, serializer):
		...
		if approved:
			...
			claim.coverage_checked = True
			claim.notes = reason
			claim.save(update_fields=['status', 'coverage_checked', 'notes'])
